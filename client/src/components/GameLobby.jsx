...
export default function GameLobby({ socket, enterRoom, onLogout }) {
  ...
  const [isPrivateRoomSettings, setIsPrivateRoomSettings] = useState(false);
  ...
  const handleCreatePrivateRoom = () => {
    setIsPrivateRoomSettings(true);
  };

  if (isPrivateRoomSettings) {
    return <RoomCreate onLogout={onLogout} username={username} />;
  }
  ...
  return (
    <div className="lobby-container">
      ...
      <div className="lobby-form">
        ...
        <button className="private-room-button" onClick={handleCreatePrivateRoom}>
          Create Private Room
        </button>
      </div>
    </div>
